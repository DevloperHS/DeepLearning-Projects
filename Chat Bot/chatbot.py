...
Original file is located at
    https://colab.research.google.com/drive/1Snh8yeDHdNyNPGmWTeL_bEuJVteZIjsm
"""

# A chatbot which parse data from an url and states resaonoable answers related to what data passed
