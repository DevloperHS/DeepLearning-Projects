...
Original file is located at
    https://colab.research.google.com/drive/1cUQps204ESesNxMU3gwS4FA_M0Qf4BVv
"""
...
content_img = plt.imread('/tmp/content.jpg')
style_img = plt.imread('/tmp/style.jpg')
...
'''Content'''
content_img = load_image('/tmp/content.jpg')

'''Style'''
style_img = load_image('/tmp/style.jpg')
